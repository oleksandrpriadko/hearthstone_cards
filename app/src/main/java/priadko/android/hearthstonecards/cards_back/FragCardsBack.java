...
import com.android.priadko.baselibrary.base_fragment.mvp.FragToolbarDrawerMainMVP;
import com.android.priadko.baselibrary.dialog_errors.ERROR_TYPES;

import java.util.List;

import priadko.android.hearthstonecards.ActCard;
...
//            Toast.makeText(getContext(), "pos " + position, Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(getActivity(), ActCard.class);
